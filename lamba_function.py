...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Welcome to Mario's sample. " \
                    "Please tell me your favorite Salomon by saying, " \
                    "my favorite Salomon is blank"
    # If the user either does not reply to the welcome message or says something
    # that is not understood, they will be prompted again with this text.
    reprompt_text = "Please tell me your favorite Salomon by saying, " \
                    "my favorite Salomon is Mario."
...
def handle_session_end_request():
    ...
    speech_output = "Thank you for trying the Mario's sample. " \
                    "Have a nice day! "
...
def on_intent(intent_request, session):
    ...
    if intent_name == "MySalomonIsIntent":
